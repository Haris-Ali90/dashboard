...
class ReportingController extends BackendController
{
    ...
    /*    dd($vendors);*/
        ...
        //$query = DB::table('sprint__sprints')->where(['sprint__sprints.creator_id' => $vendors])->whereBetween('sprint__sprints.created_at', [$from_date, $to_date])->whereNull('sprint__sprints.deleted_at');
        ...
        /*$query= DB::table('sprint__sprints')->join('sprint__tasks','sprint__tasks.sprint_id','=','sprint__sprints.id')
