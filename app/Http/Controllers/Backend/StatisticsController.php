...
//        $odt_data_1 = ['y1' => round(($totallates / $totalcount) * 100, 2), 'y2' => round(100 - (($totallates / $totalcount) * 100), 2) ,'ontime'=>  $totalcount - $totallates  , 'offtime'=> $totallates ];
        $odt_data_1 = ['y1' => 6.27, 'y2' => 93.73, 'ontime'=> 3215  , 'offtime'=> 215 ];
...
//        }
//         $odt_data_1 = ['y1' => round(($totallates / $totalcount) * 100, 2), 'y2' => round(100 - (($totallates / $totalcount) * 100), 2) ,'ontime'=>  $totalcount - $totallates  , 'offtime'=> $totallates ];
        $odt_data_1 = ['y1' => 2.36, 'y2' => 97.64 ,'ontime'=> 22451 , 'offtime'=> 541 ];
...
//        }
//         $odt_data_1 = ['y1' => round(($totallates / $totalcount) * 100, 2), 'y2' => round(100 - (($totallates / $totalcount) * 100), 2) ,'ontime'=>  $totalcount - $totallates  , 'offtime'=> $totallates ];
        $odt_data_1 = ['y1' => 5.57, 'y2' =>94.43 ,'ontime'=> 60080 , 'offtime'=> 3541 ];
...
//        }
      //  ($montreal_count['completion_ratio']+$ottawa_count['completion_ratio']+$ctc_count['completion_ratio']).'%';
        ...
        $counts['sorted'] = 3400;
        $counts['pickup'] = 7;
        $counts['delivered_order'] = 3225;
        $counts['return_orders'] = 175;
        $counts['hub_return_scan'] = 92;
        $counts['hub_not_return_scan'] = 83;
        $counts['notscan'] = 30;
        $counts['reattempted'] = 0;
...
//        $counts['remaining_route'] = $montreal_count['remaining_route']+$ottawa_count['remaining_route']+$ctc_count['remaining_route'];
        ...
        $counts['remaining_sorted'] = 3;
        $counts['remaining_pickup'] = 0;
        $counts['remaining_route'] = 1;
        return $counts;
    }
...
//        }
        $counts['failed'] = 5;
        $counts['system_failed_order'] = 2;
        $counts['not_in_system_failed_order'] = 3;
...
//            }
//        }
        $counts['total_route']= 60;
        $counts['normal_route']= 55;
        $counts['custom_route']= 4;
        $counts['big_box_route']= 1;
        return $counts;
    }
...
//        $finalList = [];
        ...
        $joeys = Joey::orderBy('id', 'DESC')->limit(10)->get();
...
//        }
        ...
        $joeys = Joey::orderBy('id', 'ASC')->limit(10)->get();
...
//        }
        $odt_data_1 = ['y1' =>17.27 , 'y2' => 82.73 ,'ontime'=>  1203, 'offtime'=> 251];
//        $odt_data_1 = ['y1' => , 'y2' => ,'ontime'=>  , 'offtime'=> ];
        return $odt_data_1;
    }
...
//
        $finalList = [];
        $i = 0;
        $brookers =BrookerUser::OrderBy('id','DESC')->limit(10)->get();
        foreach ($brookers as $brooker)
        {
