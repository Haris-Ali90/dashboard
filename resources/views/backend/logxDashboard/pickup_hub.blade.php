...
@section('title', 'Logx E-commerce Out For Delivery')
...
@section('inlineJS')
    ...
    <script>
        ...
        $(function () {
            appConfig.set('yajrabox.ajax', '{{ route('new-pickup-logx-ecommerce.data') }}');
...
{{--                            @if(can_access_route('new-pickup-logx-ecommerce-export.excel',$userPermissoins))--}}
{{--                            <div class="excel-btn" style="float: right">--}}
{{--                                <a href="{{ route('new-pickup-logx-ecommerce-export.excel') }}"--}}
