...
@section('title', 'Logx E-commerce Summary')
    ...
    <script type="text/javascript">
        ...
        $('.cards-details-datatable-show').on('click', function (e) {
            ...
            var table = $('.ctc-total-orders').DataTable({
                ...
                destroy: true,
                ajax: {
                    url: "{{ url('yajra/logx/e-commerce/reporting') }}",
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left amazon-text">
                    <h3 class="text-center">  Logx  E-commerce Summary
                        <small></small>
                    </h3>
                </div>
            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control js-example-basic-multiple vendor_name" name="creator_id">
...
{{--                                                </option>--}}
                    ...
                    <!--Count Div Row Open-->
                @include('backend.logxDashboard.reporting.logx_reporting_cards')
                <!--Count Div Row Close-->
