...
@section('title', 'Logx E-commerce Delivered Orders')
...
@section('inlineJS')
    ...
    <script>
        ...
        $(function () {
            appConfig.set('yajrabox.ajax', '{{ route('new-delivered-logx-ecommerce.data') }}');
...
{{--                            @if(can_access_route('new-delivered-logx-ecommerce-export.excel',$userPermissoins))--}}
{{--                            <div class="excel-btn" style="float: right">--}}
{{--                                <a href="{{ route('new-delivered-logx-ecommerce-export.excel') }}"--}}
