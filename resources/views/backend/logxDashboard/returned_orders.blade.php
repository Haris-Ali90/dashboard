...
@section('title', 'Logx E-commerce Returned Orders')
...
@section('inlineJS')
    ...
    <script>
        ...
        $(function () {
            appConfig.set('yajrabox.ajax', '{{ route('new-returned-logx-ecommerce.data') }}');
...
{{--                            @if(can_access_route('new-returned-logx-ecommerce-export.excel',$userPermissoins))--}}
{{--                            <div class="excel-btn" style="float: right">--}}
{{--                                <a href="{{ route('new-returned-logx-ecommerce-export.excel') }}"--}}
