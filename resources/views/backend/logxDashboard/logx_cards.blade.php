    ...
    @if(in_array($type, ['all','total']))
        <!--Animated-a Div Open-->
            ...
            <div class="animated flipInY col-lg-3 col-md-6 col-sm-12 dashbords-conts-tiles-main-wrap">
                ...
                <a href="<?php echo URL::to('/'); ?>/logx/e-commerce/order?datepicker=<?php echo isset($_GET['datepicker'])?$_GET['datepicker']: date('Y-m-d');?>&type=total">
    ...
    @if(in_array($type, ['all','return']))
        <!--Animated-c Div Open-->
            <div class="animated flipInY col-lg-3 col-md-6 col-sm-12 dashbords-conts-tiles-main-wrap">
                ...
                <!--dashbords-conts-tiles-loader-main-wrap-close-->
                <a href="<?php echo URL::to('/'); ?>/logx/e-commerce/returned?datepicker=<?php echo isset($_GET['datepicker'])?$_GET['datepicker']: date('Y-m-d');?>&type=return">
                <div class="tile-stats">
                    <div class="icon">
        ...
        @if(in_array($type, ['return']))
            ...
            <div class="animated flipInY col-lg-3 col-md-6 col-sm-12 dashbords-conts-tiles-main-wrap">
                ...
                <!--dashbords-conts-tiles-loader-main-wrap-close-->
                <a href="<?php echo URL::to('/'); ?>/logx/e-commerce/returned-not-hub?datepicker=<?php echo isset($_GET['datepicker'])?$_GET['datepicker']: date('Y-m-d');?>&type=return">
                <div class="tile-stats">
                    <div class="icon">
                        <i class="fa fa-rotate-left"></i>
                    </div>
        ...
        <!--Animated-d Div Open-->
            <div class="animated flipInY col-lg-3 col-md-6 col-sm-12 dashbords-conts-tiles-main-wrap">
                ...
                <!--dashbords-conts-tiles-loader-main-wrap-close-->
                <a href="<?php echo URL::to('/'); ?>/logx/e-commerce/sorted?datepicker=<?php echo isset($_GET['datepicker'])?$_GET['datepicker']: date('Y-m-d');?>&type=sorted">
                <div class="tile-stats">
                    <div class="icon">
        ...
        <!--Animated-e Div Open-->
            <div class="animated flipInY col-lg-3 col-md-6 col-sm-12 dashbords-conts-tiles-main-wrap">
                ...
                <!--dashbords-conts-tiles-loader-main-wrap-close-->
                <a href="<?php echo URL::to('/'); ?>/logx/e-commerce/picked/up?datepicker=<?php echo isset($_GET['datepicker'])?$_GET['datepicker']: date('Y-m-d');?>&type=picked">
                <div class="tile-stats">
                    <div class="icon">
                        <i class="fa fa-car"></i>
                    </div>
        ...
        <!--Animated-f Div Open-->
            <div class="animated flipInY col-lg-3 col-md-6 col-sm-12 dashbords-conts-tiles-main-wrap">
                ...
                <!--dashbords-conts-tiles-loader-main-wrap-close-->
                <a href="<?php echo URL::to('/'); ?>/logx/e-commerce/delivered?datepicker=<?php echo isset($_GET['datepicker'])?$_GET['datepicker']: date('Y-m-d');?>&type=delivered">
                <div class="tile-stats">
                    <div class="icon">
        ...
        <!--Animated-g Div Open-->
            <div class="animated flipInY col-lg-3 col-md-6 col-sm-12 dashbords-conts-tiles-main-wrap">
                ...
                <!--dashbords-conts-tiles-loader-main-wrap-close-->
                <a href="<?php echo URL::to('/'); ?>/logx/e-commerce/not/scan?datepicker=<?php echo isset($_GET['datepicker'])?$_GET['datepicker']: date('Y-m-d');?>&type=scan">
                <div class="tile-stats">
                    <div class="icon">
