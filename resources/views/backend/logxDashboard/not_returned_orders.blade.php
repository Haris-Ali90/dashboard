...
@section('inlineJS')
    ...
    <script>
        ...
        $(function () {
            appConfig.set('yajrabox.ajax', '{{ route('new-notreturned-logx-ecommerce.data') }}');
        ...
        function getTotalOrderData() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo URL::to('/'); ?>/logx/e-commerce/totalcards/" + selected_date + "/" + type,
                data: {},
...
{{--                            @if(can_access_route('new-notreturned-logx-ecommerce-export.excel',$userPermissoins))--}}
{{--                            <div class="excel-btn" style="float: right">--}}
{{--                                <a href="{{ route('new-notreturned-logx-ecommerce-export.excel') }}"--}}
{{--                                   class="btn buttons-excel buttons-html5 btn-sm btn-primary excelstyleclass">--}}
{{--                                    Export to Excel--}}
{{--                                </a>--}}
{{--                            </div>--}}
{{--                            @endif--}}
{{--                            @if(can_access_route('new-notreturned-logx-ecommerce-tracking-export.excel',$userPermissoins))--}}
{{--                                <div class="excel-btn" style="float: right">--}}
{{--                                    <a href="{{ route('new-notreturned-logx-ecommerce-tracking-export.excel') }}"--}}
{{--                                       class="btn buttons-excel buttons-html5 btn-sm btn-primary excelstyleclass">--}}
