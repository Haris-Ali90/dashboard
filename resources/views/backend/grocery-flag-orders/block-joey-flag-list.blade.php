...
@section('title', 'Block Joeys Grocery Flag List')
...
@section('inlineJS')
    ...
    <script type="text/javascript">
        ...
        $DataTable = $('.flag-orders-table').DataTable({
            ...
            processing: true,
            ajax: {
                url: '{{ route('grocery-block-joey-flag-list.data') }}',
                data: function(data) {
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <!-- <h3>Block Joeys Grocery Flag List<small></small></h3> -->
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Block Joeys Grocery Flag List</h2>
