        ...
        <div class="stages_list">
            <div class="col col-lg-4 col-md-6 col-sm-12">
                <div class="stage_box link-wrap basicRegistration ">
                    ...
                    <div class="label">Total Grocery Flag Drivers</div>
                </div>
            </div>
            <div class="col col-lg-4 col-md-6 col-sm-12">
                <div class="stage_box link-wrap">
                    ...
                    <div class="label">Total Grocery Flag Mark</div>
                </div>
            </div>
            <div class="col col-lg-4 col-md-6 col-sm-12">
                <div class="stage_box link-wrap">
                    ...
                    <div class="label">Approved Grocery Flag Orders</div>
                </div>
            </div>
        </div>
</div>
    ...
    <div class="stages_list">
            <div class="col col-lg-4 col-md-6 col-sm-12">
                <div class="stage_box link-wrap">
                    ...
                    <div class="label">Un-Approved Grocery Flag Orders</div>
                </div>
            </div>
            <div class="col col-lg-4 col-md-6 col-sm-12">
                <div class="stage_box link-wrap">
                    ...
                    <div class="label">Grocery Un-Flag Orders</div>
                </div>
            </div>
            <div class="col col-lg-4 col-md-6 col-sm-12">
                <div class="stage_box link-wrap">
                    ...
                    <div class="label">Drivers Blocked By Flag</div>
                </div>
            </div>
        </div>
