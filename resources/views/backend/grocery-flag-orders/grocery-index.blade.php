...
@section('title', 'Grocery Flag Order List')
...
@section('inlineJS')
    ...
    <script type="text/javascript">
        ...
        function getExportFileName() {
            ...
            return 'All Grocery Flag Order List '+filter_start_date+" to "+filter_start_end;
        ...
        $DataTable = $('.flag-orders-table').DataTable({
            ...
            processing: true,
            ajax: {
                url: '{{ route('grocery-flag-order-list.data') }}',
                data: function(data) {
        ...
        let pieChartHendler = {
            ...
            "methods":{
                "loadPieChartData": function () {
                    ...
                    $.ajax({
                        type: "get",
                        url: "{{route('grocery-flag-order-list-pie-chart-data')}}",
                        data: {
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    @include('backend.grocery-flag-orders.flag-order-cards')
                    <h3><small></small></h3>
                </div>
            </div>
            ...
            <div class="row charts-box-main-wrap">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Grocery Flag Orders Pie Chart  </h2>
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                           <div class="row">
                            <div class="col-lg-6">
                            <h2>Grocery Flag Orders List</h2>
                           </div>
                           <div class="col-lg-6">
