...
@section('title', 'Grocery Approved Flag List')
...
@section('inlineJS')
    ...
    <script type="text/javascript">
        ...
        function getExportFileName() {
            ...
            return 'Approved Grocery Flag List '+filter_start_date+" to "+filter_start_end;
        ...
        $DataTable = $('.flag-orders-table').DataTable({
            ...
            processing: true,
            ajax: {
                url: '{{ route('grocery-approved-flag-list.data') }}',
                data: function(data) {
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <!-- <h3>Approved Grocery Flag Orders<small></small></h3> -->
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <div class="col-lg-6">
                            <h2>Approved Grocery Flag Orders List</h2>
                            </div>
                            <div class="col-lg-6">
                            <div class="dt-buttons" style="float: right">
                                <button class="datatable-csv-download-btn c-btn" style="border-radius:6px !important; " type="button">
                        ...
                        <form class="form-horizontal table-top-form-from">
                            ...
                            <div class="row table-top-form-row">
                                ...
                                <div class="col-sm-3 col-md-2 table-top-form-col-warp">
                                    <button class="btn c-btn btn-primary form-submit-btn"  type="button"> Filter </button>
                                </div>
