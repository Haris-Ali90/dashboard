...
@section('title', 'Grocery Flag Order Detail')
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3>Grocery Flagged Order Details</h3>
                </div>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Grocery Flagged Order Details <small></small></h2>
                        ...
                        <div class="x_content">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                    <tr>
                                        <td style="width: 30%;"><label>Merchant Order No </label></td>
                                        <td>{{$JoeyPerformanceHistory->merchant_order_num or "N/A"}}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{(isset($JoeyPerformanceHistory->MerchantOrderNo->Task->taskContact->phone)) ? $JoeyPerformanceHistory->MerchantOrderNo->Task->taskContact->phone: "N/A"}}</td>
                                    </tr>
                                    <tr>
                                        <td><label>Address</label></td>
                                        <td> {{(isset($JoeyPerformanceHistory->MerchantOrderNo->Task->task_Location->address)) ? $JoeyPerformanceHistory->MerchantOrderNo->Task->task_Location->address: "N/A"}}</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="x_title">
                                <h2>All Approved Grocery Flagged Order History "{{$JoeyPerformanceHistory->joeyName->FullName}}" <small></small></h2>
                            ...
                            <div class="x_content">
                                <table class="table table-striped table-bordered flag-orders-table" >
                                    ...
                                    @foreach($AllFlagsOrderJoeys as $key => $FlagOrder)
                                        <tr>
                                            <td>{{$key+1}}</td>
                                            <td>{{$FlagOrder->merchant_order_num}}</td>
