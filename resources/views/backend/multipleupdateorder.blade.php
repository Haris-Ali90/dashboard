                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title border-0">
                          <div class="col-lg-12">
                          <h2>Multiple Status Update</h2>
                          </div>
                          <form method="post" action="../../update/multiple/trackingid">
                           <div class="form-group">
                           <input type="hidden" name="_token" value="{{ csrf_token() }}">
                              <div class="col-lg-12">
                              <textarea rows='1' cols="50" name="tracking_id" placeholder="Tracking Id" value=""  style="line-height:25px !important; width:100% !important; margin-bottom:10px"></textarea> 
                              </div>
                                
                                 <div class="col-lg-12">
                                 <select id="status_id" name="status_id"  class='' required  style="width:100% !important; margin-bottom:10px"> 
                             ...
                             <button class="btn orange-gradient c-btn " type="submit" style="margin-top: -3%,4%">Update </button>
                             </div>
