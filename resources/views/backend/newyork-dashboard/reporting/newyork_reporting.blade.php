...
@section('title', 'New York Summary')
    ...
    <script type="text/javascript">
        ...
        $('.cards-details-datatable-show').on('click', function (e) {
            ...
            function getExportFileName() {
                ...
                return 'New York Summary '+date_date;
            ...
            var table = $('.ctc-total-orders').DataTable({
                ...
                destroy: true,
                ajax: {
                    url: "{{ url('yajra/newyork-dashboard/reporting') }}",
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left amazon-text">
                    <h3 class="text-center"> New York Summary
                        <small></small>
                    </h3>
                </div>
            </div>
...
{{--                                    </div>--}}
                        ...
                        <!--Count Div Row Open-->
                    @include('backend.newyork-dashboard.reporting.newyork_reporting_cards')
                    <!--Count Div Row Close-->
