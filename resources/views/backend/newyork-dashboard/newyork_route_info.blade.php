...
@section('title', 'New York Route Info')
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left amazon-text">
                    <h3 class="text-center">  New York Route Info<small></small></h3>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>New York <small>Route Info</small></h2>
                            @if(can_access_route('export_newyorkRouteInfo.excel',$userPermissoins))
                                ...
                                <table id="datatable" class="table table-striped table-bordered">
                                    ...
                                    @foreach( $boradless_info as $record )
                                        <tr>
                                            ...
                                            <td id="actiontab">
                                                @if(can_access_route('newyork_dashboard_route.detail',$userPermissoins))
                                                    <a href="{{backend_url('newyork-dashboard/route/'.$record->id.'/edit/hub/19')}}" title="Route Details" target='_blank' class="btn btn-warning btn-xs" style="float: left;">Route Details
                                                    </a><br>
                                                @endif
