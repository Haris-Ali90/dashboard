...
@section('title', 'New York Pickup At Store')
...
@section('inlineJS')
    ...
    <script>
        ...
        $(function () {
            appConfig.set('yajrabox.ajax', '{{ route('pickup-newyork.data') }}');
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3 class="text-center">{{ $title_name }} Pickup At Store<small></small></h3>
                </div>
            </div>
        ...
        @include('backend.newyork-dashboard.newyork_cards')
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>{{ $title_name }} <small>Pickup At Store</small></h2>
                            @if(can_access_route('pickup-newyork-export.excel',$userPermissoins))
                            <div class="excel-btn" style="float: right">
                                <a href="{{ route('pickup-newyork-export.excel') }}"
