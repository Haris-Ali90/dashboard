...
@section('inlineJS')
    ...
    <script>
        ...
        $(function () {
            appConfig.set('yajrabox.ajax', '{{ route('newyork-dashboard.data') }}');
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            @if(can_access_route('newyork-dashboard-export.excel',$userPermissoins))
                            <div class="excel-btn" style="float: right">
                                <a href="{{ route('newyork-dashboard-export.excel') }}"
                            ...
                            @if(can_access_route('newyork-dashboard-export-otd-report.excel',$userPermissoins))
                                <div class="excel-btn" style="float: right">
                                    <a href="{{ route('newyork-dashboard-export-otd-report.excel') }}"
                                       class="btn buttons-excel buttons-html5 btn-sm btn-primary excelstyleclass"
                                       target="_blank">
                                        OTD Report
                                    </a>
