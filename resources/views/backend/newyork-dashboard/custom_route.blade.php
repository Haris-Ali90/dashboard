...
@section('title', 'New York Custom Route Orders')
...
@section('inlineJS')
    ...
    <script>
        ...
        $(function () {
            appConfig.set('yajrabox.ajax', '{{ route('custom-route-newyork.data') }}');
        ...
        function getCustomRouteData() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo URL::to('/'); ?>/newyork-dashboard/customroutecards/" + selected_date,
                data: {},
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            @if(can_access_route('custom-route-newyork-export.excel',$userPermissoins))
                            <div class="excel-btn" style="float: right">
                                <a href="{{ route('custom-route-newyork-export.excel') }}"
