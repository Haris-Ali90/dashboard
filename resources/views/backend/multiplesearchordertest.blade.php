                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_title">
                            ...
                            <form method="get" action="{{ route('test-search-multiple-tracking.index') }}" id="">
                                ...
                                <table id="datatable" class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="Status btn green-gradient  xbtn"  data-id='<?php echo $response->id; ?>'>Update Status</a>
    ...
    <div id="ex4" class="modal" style="display: none">
        <div class='modal-dialog'>
            ...
            <div class='modal-content'>
                ...
                <form action="<?php echo URL::to('/'); ?>/update/order/status/test" method="post">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
