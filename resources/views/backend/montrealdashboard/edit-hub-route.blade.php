<?php
use App\SprintTaskHistory;use Illuminate\Support\Facades\DB;$status = array(
  ...
  <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script> -->
    ...
    height: 80px;" alt="' . $routeLoc->tracking_id . '"/>';
                                    ...
                                    /*       echo "<td>".$routeLoc->merchant_order_num."</td>";
                                           ...
                                           "</td>";*/
                                    $delivery_time = SprintTaskHistory::where('sprint_id', $routeLoc->sprint_id)
                                        ->select((DB::raw('MAX(CASE WHEN status_id IN (17,113,114,116,117,118,132,138,139,144,101,102,103,104,105,106,107,108,109,110,111,112,131,135,136) THEN CONVERT_TZ(created_at,"UTC","America/Toronto") ELSE NULL END) as delivery_time')))->first();
                                    ...
                                    @if(can_access_route('montrealinfo_route.detail',$userPermissoins))
                                        <a href="{{backend_url('montreal/route/orders/trackingid/'.$routeLoc->sprint_id.'/details')}}"
                                           target='_blank' class='btn btn-warning btn-xs'>Detail</a>
                                    @endif
                                    <?php echo "</td>";
                                    echo "</tr>";
                                    $i++;
