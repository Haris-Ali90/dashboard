    ...
    <script type="text/javascript">
        ...
        $('.cards-details-datatable-show').on('click', function (e) {
            ...
            function getExportFileName() {
                ...
                return 'Ottawa Summary '+date_date;
            ...
            var table = $('.ctc-total-orders').DataTable({
                ...
                destroy: true,
                ajax: {
                    url: "{{ url('yajra/ottawa-dashboard/reporting') }}",
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left amazon-text">
                    <h3 class="text-center"> Ottawa Summary
                        <small></small>
                    </h3>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <!--Count Div Row Open-->
                    @include('backend.ottawa-dashboard.reporting.ottawa_reporting_cards')
                    <!--Count Div Row Close-->
