...
@section('title', 'Ottawa Custom Route Orders')
...
@section('inlineJS')
    ...
    <script>
        ...
        $(function () {
            appConfig.set('yajrabox.ajax', '{{ route('new-custom-route-ottawa.data') }}');
        ...
        function getCustomRouteData() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo URL::to('/'); ?>/ottawa-dashboard/customroutecards/" + selected_date,
                data: {},
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            @if(can_access_route('new-custom-route-ottawa-export.excel',$userPermissoins))
                            <div class="excel-btn" style="float: right">
                                <a href="{{ route('new-custom-route-ottawa-export.excel') }}"
