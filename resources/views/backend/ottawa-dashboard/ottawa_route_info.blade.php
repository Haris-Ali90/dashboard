        ...
        <div class="">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Ottawa <small>Route Info</small></h2>
                            @if(can_access_route('new-export_OttawaRouteInfo.excel',$userPermissoins))
                                ...
                                <table id="datatable" class="table table-striped table-bordered">
                                    ...
                                    @foreach( $boradless_info as $record )
                                        <tr>
                                            ...
                                            <td id="actiontab">
                                                @if(can_access_route('ottawa_dashboard_route.detail',$userPermissoins))
                                                    <a href="{{backend_url('ottawa-dashboard/route/'.$record->id.'/edit/hub/19')}}" title="Route Details" target='_blank' class="btn btn-warning btn-xs" style="float: left;">Route Details
                                                    </a>
                                                @endif
                                                ...
                                                @endif
                                                    ...
                                                    <button type='button' class='orange-gradient btn btn-xs @if($cmap_data == '[]')hidden @else enabled @endif' data-toggle='modal' data-target='#ex5' onclick='currentMap({{$route_id}})' title='Map of Current Route'>CMap</button>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
