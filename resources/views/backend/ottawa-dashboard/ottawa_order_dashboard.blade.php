...
@section('inlineJS')
    ...
    <script>
        ...
        $(function () {
            appConfig.set('yajrabox.ajax', '{{ route('new-order-ottawa.data') }}');
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left amazon-text">
                    <h3 class="text-center">Ottawa Dashboard
                        <small></small>
                    </h3>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>
                                <small>Ottawa Dashboard</small>
                            </h2>

                            @if(can_access_route('new-order-ottawa-export.excel',$userPermissoins))
                                <div class="excel-btn" style="float: right">
                                    <a href="{{ route('new-order-ottawa-export.excel') }}"
