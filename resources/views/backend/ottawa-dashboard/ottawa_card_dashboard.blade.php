    ...
    <script>
        ...
        function getTotalOrderData() {
            ...
            $.ajax({
                ...
                success: function (data) {
                    $('#total_orders').text(data['ottawa_count']['total']);
                    $('#return_orders').text(data['ottawa_count']['return_orders']);
                    $('#sorted_orders').text(data['ottawa_count']['sorted']);
                    $('#picked_orders').text(data['ottawa_count']['pickup']);
                    $('#delivered_orders').text(data['ottawa_count']['delivered_order']);
                    $('#notscan_orders').text(data['ottawa_count']['notscan']);
                    $('#reattempted_orders').text(data['ottawa_count']['reattempted']);
                    $('#completion_order').text(data['ottawa_count']['completion_ratio']);
                    // hide loader
        ...
        function getInProgressOrdersData() {
            ...
            $.ajax({
                ...
                data: {},
                success: function (data) {
                    $('#sorted_remain').text(data['ottawa_inprogess_count']['remaining_sorted']);
                    $('#picked_remain').text(data['ottawa_inprogess_count']['remaining_pickup']);
                    $('#route_picked_remain').text(data['ottawa_inprogess_count']['remaining_route']);
                    // hide loader
