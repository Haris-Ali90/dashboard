...
@section('title', 'Toronto Reattempted Orders')
...
@section('inlineJS')
    ...
    <script>
        ...
        $(function () {
            ...
            appConfig.set('yajrabox.ajax', '{{ route('to-be-reattemptedorders-borderless.data') }}');
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                          <div class="col-lg-6">
                          <h2>{{ $title_name }} To Be Re Attempted Orders<small></small></h2>
                          </div>
                            ...
                            @endif--}}
                            @if(can_access_route('new-reattemptedorders-borderless-tracking-export.excel',$userPermissoins))
                                <div class="excel-btn" style="float: right">
                                    <a href="{{ route('new-reattemptedorders-borderless-tracking-export.excel') }}"
