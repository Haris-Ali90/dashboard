...
@section('title', 'Toronto Re Delivery Orders')
...
@section('inlineJS')
    ...
    <script>
        ...
        $(function () {
            ...
            appConfig.set('yajrabox.ajax', '{{ route('re-delivery-orders-borderless.data') }}');
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                         <div class="col-lg-8">
                         <h2>{{ $title_name }} Returned To Hub For Re Delivery Orders  <small></small></h2>
                         </div>
                            ...
                            @endif--}}
                            @if(can_access_route('re-delivery-orders-borderless-tracking-export.excel',$userPermissoins))
                                <div class="excel-btn" style="float: right">
                                    <a href="{{ route('re-delivery-orders-borderless-tracking-export.excel') }}"
                                       class="btn buttons-excel buttons-html5 btn-sm btn-primary excelstyleclass c-btn">
