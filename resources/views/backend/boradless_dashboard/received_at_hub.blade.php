...
@section('title', 'Toronto Return Received At Hub')
...
@section('inlineJS')
    ...
    <script>
        ...
        $(function () {
            ...
            appConfig.set('yajrabox.ajax', '{{ route('new-receivedathub-borderless.data') }}');
        ...
        function getTotalOrderData() {
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    ...
                    // $('#return_orders').text(data['boradless_count']['hub_return_scan'] + data['boradless_count']['hub_return_not_scan']);
                    ...
                    // $('#hub_not_return_scan').text(data['boradless_count']['hub_return_not_scan']);
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <!-- <h3 class="text-center">{{ $title_name }} Return Received At Hub<small></small></h3> -->
                </div>
            </div>
        ...
        @include('backend.boradless_dashboard.boradless_cards')
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>{{ $title_name }} Return Received At Hub  <small></small></h2>
                            {{--@if(can_access_route('new-receivedathub-borderless-export.excel',$userPermissoins))
                            <div class="excel-btn" style="float: right">
                                <a href="{{ route('new-receivedathub-borderless-export.excel') }}"
                                   class="btn buttons-excel buttons-html5 btn-sm btn-primary excelstyleclass ">
                                    Export to Excel
                                </a>
                            </div>
                            @endif--}}
                            @if(can_access_route('new-receivedathub-borderless-tracking-export.excel',$userPermissoins))
                                <div class="excel-btn" style="float: right">
                                    <a href="{{ route('new-receivedathub-borderless-tracking-export.excel') }}"
