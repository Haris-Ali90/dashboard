...
@section('title', 'Toronto Custom Route Orders')
...
@section('inlineJS')
    ...
    <script>
        ...
        function getCustomRouteData() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo URL::to('/'); ?>/toronto/customroutecards/" + selected_date + "/" +selected_vendor,
                data: {},
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                          <div class="col-lg-6">
                          <h2>{{ $title_name }} Custom Route Orders <small></small></h2>
                          </div>
                        <div class="col-lg-6">
