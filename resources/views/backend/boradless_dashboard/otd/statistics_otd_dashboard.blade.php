        ...
        <div class="">
            <div class="page-title">
                <div class="title_left amazon-text">
                    <!-- <h3 class="text-center"> Toronto Graph<small></small></h3> -->
                </div>
            </div>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title col-md-12">
                            <h2>Toronto Graph<small></small></h2>
                            <div class="clearfix"></div>
                        </div>
                        ...
                        <div class="col-sm-12 ctc-statistics-dashboard-btn-warp">
                            ...
                            <div class="col-sm-2 col-lg-4 ctc-statistics-checkbox-wrap">
...
@section('inlineJS')
    <script>
        ...
        function walmart_ajax_statistics_call(el,url_for,targeted_div) {
            ...
            $.ajax({
                type: "get",
                url: '{{ URL::to('toronto/dashboard/statistics/ajax/')}}/'+url_for,
                data:{'date':date},
