...
@section('inlineJS')
    ...
    <script>
        ...
        $(function () 
        {
            ...
            appConfig.set('dt.searching', false);  //searching fail
            ...
            appConfig.set('yajrabox.columns', [
                {data: 'sprint_id', orderable: true, searchable: false},
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left amazon-text">
                    ...
                    <h3 class="text-center">  <small></small>
                    </h3>
                </div>
            </div>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title d-flex">
                           <div class="col-lg-6">
                           <h2 class="text-left">Client Dashboard
                                <small></small>
                            </h2>
                         ...
                         @if(can_access_route('borderless-dashboard-export.excel',$userPermissoins))
                            <div class="excel-btn">
                                <a href="{{ route('borderless-dashboard-export.excel') }}"
                                   class="c-btn buttons-excel buttons-html5 btn-sm btn-primary excelstyleclass"
                                   target="_blank">
                                    Export to Excel
                                </a>
                            </div>
                        ...
                        <div class="x_title">
                            <form method="get" action="">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control " name="store_name" id="store-filter">
                                                ...
                                                <option value="testVendorId" {{ ($selectVendor=='testVendorId')?'selected': '' }}>Test Vendor</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <button class=" c-btn" type="submit" style="margin-top: 24px; padding-bottom: 9px;">
                                                Go
                                            </a> </button>
                                        </div>
                                    </div>
