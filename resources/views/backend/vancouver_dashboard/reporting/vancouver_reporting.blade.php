...
@section('title', 'Vancouver Summary')
...
@section('inlineJS')
    ...
    <script type="text/javascript">
        ...
        $('.cards-details-datatable-show').on('click', function (e) {
            ...
            let vendor_data = $('.vendor_name').find(":selected").val();
            ...
            function getExportFileName() {
                ...
                return 'Vancouver Summary '+date_date;
            ...
            var table = $('.ctc-total-orders').DataTable({
                ...
                destroy: true,
                ajax: {
                    url: "{{ url('yajra/vancouver/reporting') }}",
                    data: function (req_data) {
                        ...
                        req_data.vendor_data = vendor_data;
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left amazon-text">
                    <h3 class="text-center"> Vancouver Summary
                        <small></small>
                    </h3>
                </div>
            </div>
                                ...
                                <div class="row">
                                    ...
                                    {{--<div class="col-md-3">
                                        ...
                                        <select class="form-control" name="city" id="city">
                                            ...
                                            <option value="ottawa" {{( $city == 'ottawa') ? 'Selected' : ''}}>Ottawa
                                            </option>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control js-example-basic-multiple vendor_name"
                                                    name="creator_id">
...
{{--                                                <option value="walmart_vendors" {{ ($selectVendor=='walmart_vendors')?'selected': '' }}>--}}
{{--                                                    Walmart--}}
{{--                                                </option>--}}
{{--                                                <option value="shiphero_vendors" {{ ($selectVendor=='shiphero_vendors')?'selected': '' }}>--}}
{{--                                                    Ship Hero--}}
{{--                                                </option>--}}
{{--                                                <option value="borderless_vendors" {{ ($selectVendor=='borderless_vendors')?'selected': '' }}>--}}
{{--                                                    Border Less--}}
{{--                                                </option>--}}
{{--                                                <option value="ctc_vendors" {{ ($selectVendor=='ctc_vendors')?'selected': '' }}>--}}
{{--                                                    CTC Store--}}
{{--                                                </option>--}}
                                            </select>
                                        </div>
                        ...
                        <!--Count Div Row Open-->
                    @include('backend.vancouver_dashboard.reporting.vancouver_reporting_cards')
                    <!--Count Div Row Close-->
                            ...
                            <div class="table-responsive ">
                                <table class="table table-striped table-bordered">
                                    ...
                                    @foreach($boradless_range_count as $key=> $value)
                                        <tr>
                                            <td>{{ $key}}</td>
                                            <td class="cards-details-datatable-show" date-date="{{$key}}"
                                                city-data="{{$city}}" data-type="total_orders"
                                                data-target="total-orders" data-ajax-status="false" id="total-order">
                                                <button style="font-weight: bold;"
                                                        class="btn btn-link">{{ $value['total']  }}</button>
                                            </td>
                                            <td class="cards-details-datatable-show" date-date="{{$key}}"
                                                city-data="{{$city}}" data-type="picked-up" data-target="picked-up"
                                                data-ajax-status="false" id="picked-up">
                                                <button style="font-weight: bold;"
                                                        class="btn btn-link">{{$value['picked-up'] }}</button>
                                            </td>
                                            <td class="cards-details-datatable-show" date-date="{{$key}}"
                                                city-data="{{$city}}" data-type="at-hub" data-target="at-hub"
                                                data-ajax-status="false" id="at-hub">
                                                <button style="font-weight: bold;"
                                                        class="btn btn-link">{{$value['at-hub'] }}</button>
                                            </td>
                                            <td class="cards-details-datatable-show" date-date="{{$key}}"
                                                city-data="{{$city}}" data-type="at-store" data-target="at-store"
                                                data-ajax-status="false" id="at-store">
                                                <button style="font-weight: bold;"
                                                        class="btn btn-link">{{$value['at-store'] }}</button>
                                            </td>
                                            <td class="cards-details-datatable-show" date-date="{{$key}}"
                                                city-data="{{$city}}" data-type="sorted-order"
                                                data-target="sorted-order" data-ajax-status="false" id="sorted-order">
                                                <button style="font-weight: bold;"
                                                        class="btn btn-link">{{$value['sorted-order'] }}</button>
                                            </td>
                                            <td class="cards-details-datatable-show" date-date="{{$key}}"
                                                city-data="{{$city}}" data-type="out-for-delivery"
                                                data-target="out-for-delivery" data-ajax-status="false"
                                                id="out-for-delivery">
                                                <button style="font-weight: bold;"
                                                        class="btn btn-link">{{$value['out-for-delivery'] }}</button>
                                            </td>
                                            <td class="cards-details-datatable-show" date-date="{{$key}}"
                                                city-data="{{$city}}" data-type="delivered-order"
                                                data-target="delivered-order" data-ajax-status="false"
                                                id="delivered-order">
                                                <button style="font-weight: bold;"
                                                        class="btn btn-link">{{$value['delivered-order'] }}</button>
                                            </td>
                                            <td class="cards-details-datatable-show" date-date="{{$key}}"
                                                city-data="{{$city}}" data-type="returned" data-target="returned"
                                                data-ajax-status="false" id="returned">
                                                <button style="font-weight: bold;"
                                                        class="btn btn-link">{{$value['returned'] }}</button>
                                            </td>
                                            <td class="cards-details-datatable-show" date-date="{{$key}}"
                                                city-data="{{$city}}" data-type="returned-to-merchant"
                                                data-target="returned-to-merchant" data-ajax-status="false"
                                                id="returned-to-merchant">
                                                <button style="font-weight: bold;"
                                                        class="btn btn-link">{{$value['returned-to-merchant'] }}</button>
                                            </td>
                                        </tr>
