...
@section('title', 'Vancouver Returned Orders')
...
@section('inlineJS')
    ...
    <script>
        ...
        $(function () {
            appConfig.set('yajrabox.ajax', '{{ route('new-returned-vancouver.data') }}');
        ...
        function getTotalOrderData() {
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    ...
                    $('#hub_return_scan').text(data['vancouver_count']['hub_return_scan']);
                    $('#hub_not_return_scan').text(data['vancouver_count']['return_orders'] - data['vancouver_count']['hub_return_scan']);
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            @if(can_access_route('new-returned-vancouver-export.excel',$userPermissoins))
                            <div class="excel-btn" style="float: right">
                                <a href="{{ route('new-returned-vancouver-export.excel') }}"
