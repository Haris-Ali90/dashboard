...
@section('title', 'Vancouver Statistics')
...
@section('inlineJS')
    ...
    <script>
        ...
        function getTotalOrderData() {
            ...
            $.ajax({
                ...
                success: function (data) {
                    $('#total_orders').text(data['vancouver_count']['total']);
                    $('#return_orders').text(data['vancouver_count']['return_orders']);
                    $('#sorted_orders').text(data['vancouver_count']['sorted']);
                    $('#picked_orders').text(data['vancouver_count']['pickup']);
                    $('#delivered_orders').text(data['vancouver_count']['delivered_order']);
                    $('#notscan_orders').text(data['vancouver_count']['notscan']);
                    $('#reattempted_orders').text(data['vancouver_count']['reattempted']);
                    $('#completion_order').text(data['vancouver_count']['completion_ratio']);
                    // hide loader
        ...
        function getInProgressOrdersData() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo URL::to('/'); ?>/vancouver/inprogress/" + selected_date + "/" + type,
                data: {},
                success: function (data) {
                    $('#sorted_remain').text(data['vancouver_inprogess_count']['remaining_sorted']);
                    $('#picked_remain').text(data['vancouver_inprogess_count']['remaining_pickup']);
                    $('#route_picked_remain').text(data['vancouver_inprogess_count']['remaining_route']);
                    // hide loader
        ...
        function getCustomRouteData() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo URL::to('/'); ?>/vancouver/customroutecards/" + selected_date,
                data: {},
                success: function (data) {
        ...
        function getYesterdayOrderData() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo URL::to('/'); ?>/vancouver/yesterdaycards/" + selected_date,
                data: {},
                success: function (data) {
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left amazon-text">
                    <h3 class="text-center">Vancouver Statistics
                        <small></small>
                    </h3>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>
                                <small>Vancouver Statistics</small>
                            </h2>
