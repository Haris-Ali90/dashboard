...
@section('title', 'Vancouver Route Info')
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left amazon-text">
                    <h3 class="text-center">  Vancouver Route Info<small></small></h3>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Vancouver <small>Route Info</small></h2>
                            @if(can_access_route('export_vancouverRouteInfo.excel',$userPermissoins))
                        ...
                        <div class="x_title">
                            ...
                            <div class="row dashbords-conts-tiles-main-wrap" id="VancouverCards">
                                <div class="top_tiles montreal-dashbord-tiles" id="vancouver-dashbord-tiles-id">
                                    <div class="top_tiles vancouver-dashbord-tiles" id="">
                                ...
                                <table id="datatable" class="table table-striped table-bordered">
                                    ...
                                    @foreach( $boradless_info as $record )
                                        <tr>
                                            ...
                                            <td id="actiontab">
                                                @if(can_access_route('vancouver_route.detail',$userPermissoins))
                                                    <a href="{{backend_url('vancouver/route/'.$record->id.'/edit/hub/17')}}" title="Route Details" target='_blank' class="btn btn-warning btn-xs" style="float: left;">Route Details
                                                    </a>
                                                @endif
                                                ...
                                                @endif
                                                    ...
                                                    @endphp
                                                    <button type='button' class='orange-gradient btn btn-xs @if($joey_location == null)hidden @else enabled @endif' data-toggle='modal' data-target='#ex5' onclick='initialize({{$route_id}},{{$latitude/1000000}},{{$longitude/$devisor}},{{$joey_location}})' title='Map of Whole Route' id="joey-map">See Joey Map</button>
