...
@section('title', 'Walmart E-commerce Statistics')
...
@section('inlineJS')
    ...
    <script>
        ...
        function getInProgressOrdersData() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo URL::to('/'); ?>/walmart/e-commerce/inprogress/" + selected_date + "/" + type,
                data: {},
                success: function (data) {
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left amazon-text">
                    <h3 class="text-center">Walmart E-commerce Statistics
                        <small></small>
                    </h3>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>
                                <small>Walmart E-commerce Statistics</small>
                            </h2>
