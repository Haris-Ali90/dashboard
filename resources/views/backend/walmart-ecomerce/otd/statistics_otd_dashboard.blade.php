...
@section('title', 'Walmart E-commerce Graph')
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left amazon-text">
                    <h3 class="text-center"> Walmart E-commerce Graph<small></small></h3>
                </div>
            </div>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title col-md-12">
                            <h2>Walmart E-commerce Graph<small></small></h2>
                            <div class="clearfix"></div>
                        </div>
...
@section('inlineJS')
    <script>
        ...
        function walmart_ajax_statistics_call(el,url_for,targeted_div) {
            ...
            $.ajax({
                type: "get",
                url: '{{ URL::to('walmart/e-commerce/dashboard/statistics/ajax/')}}/'+url_for,
                data:{'date':date},
