...
@section('title', 'WildFork E-commerce Summary')
    ...
    <script type="text/javascript">
        ...
        $('.cards-details-datatable-show').on('click', function (e) {
            ...
            var table = $('.ctc-total-orders').DataTable({
                ...
                destroy: true,
                ajax: {
                    url: "{{ url('yajra/wildfork/e-commerce/reporting') }}",
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left amazon-text">
                    <h3 class="text-center">  WildFork  E-commerce Summary
                        <small></small>
                    </h3>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>WildFork E-commerce Summary
                                <small></small>
                            </h2>
