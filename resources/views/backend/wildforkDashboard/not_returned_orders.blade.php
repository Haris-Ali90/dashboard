...
@section('title', 'WildFork E-commerce Dashboard')
...
@section('inlineJS')
    ...
    <script>
        ...
        $(function () {
            appConfig.set('yajrabox.ajax', '{{ route('new-notreturned-wildfork-ecommerce.data') }}');
            ...
            appConfig.set('yajrabox.columns', [
               ...
               // {data: 'delivered_at', orderable: true, searchable: true,className: 'text-center'},
                ...
                {data: 'tip', orderable: false, searchable: false, className: 'text-center'},
        ...
        function getTotalOrderData() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo URL::to('/'); ?>/wildfork/e-commerce/totalcards/" + selected_date + "/" + type,
                data: {},
...
@section('content')
    ...
    <div class="right_col" role="main">
        <div class="">
            ...
            <!--Count Div Row Open-->
            @include('backend.wildforkDashboard.wildfork_cards')
            <!--Count Div Row Close-->
...
{{--                            @if(can_access_route('new-notreturned-wildfork-ecommerce-export.excel',$userPermissoins))--}}
{{--                            <div class="excel-btn" style="float: right">--}}
{{--                                <a href="{{ route('new-notreturned-wildfork-ecommerce-export.excel') }}"--}}
{{--                                   class="btn buttons-excel buttons-html5 btn-sm btn-primary excelstyleclass">--}}
{{--                                    Export to Excel--}}
{{--                                </a>--}}
{{--                            </div>--}}
{{--                            @endif--}}
{{--                            @if(can_access_route('new-notreturned-wildfork-ecommerce-tracking-export.excel',$userPermissoins))--}}
{{--                                <div class="excel-btn" style="float: right">--}}
{{--                                    <a href="{{ route('new-notreturned-wildfork-ecommerce-tracking-export.excel') }}"--}}
{{--                                       class="btn buttons-excel buttons-html5 btn-sm btn-primary excelstyleclass">--}}
                            ...
                            <form method="get" action="">
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <input type="date" name="datepicker" class="data-selector form-control" required="" id="store-filter"
