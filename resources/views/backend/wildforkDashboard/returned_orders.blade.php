...
@section('title', 'WildFork E-commerce Returned Orders')
...
@section('inlineJS')
    ...
    <script>
        ...
        $(function () {
            appConfig.set('yajrabox.ajax', '{{ route('new-returned-wildfork-ecommerce.data') }}');
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3 class="text-center">{{ $title_name }} Returned Orders<small></small></h3>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>{{ $title_name }} <small>Returned Orders</small></h2>
{{--                            @if(can_access_route('new-returned-wildfork-ecommerce-export.excel',$userPermissoins))--}}
{{--                            <div class="excel-btn" style="float: right">--}}
{{--                                <a href="{{ route('new-returned-wildfork-ecommerce-export.excel') }}"--}}
