...
@section('inlineJS')
    ...
    <script>
        ...
        $(function () {
            ...
            appConfig.set('yajrabox.ajax', '{{ route('new-wildfork.data') }}');
...
{{--                            @if(can_access_route('new-wildfork-export.excel',$userPermissoins))--}}
{{--                            <div class="excel-btn" style="float: right">--}}
{{--                            <a  href="{{ route('new-wildfork-export.excel') }}"--}}
                        ...
                        <div class="x_content">
                            ...
                            <table class="table table-striped table-bordered yajrabox" id="yajra-reload">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center ">Estimated Pick Up Time</th>
