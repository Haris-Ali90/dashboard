...
@section('inlineJS')
    ...
    <script>
        ...
        $(function () {
            appConfig.set('yajrabox.ajax', '{{ route('new-order-wildfork-ecommerce.data') }}');
            ...
            appConfig.set('yajrabox.columns', [
                ...
                {data: 'eta_pickup', orderable: false, searchable: false, className: 'text-center'},
        ...
        function getTotalOrderData() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo URL::to('/'); ?>/wildfork/e-commerce/totalcards/" + selected_date + "/" + type + "/" +selected_vendor,
                data: {},
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left amazon-text">
                    <h3 class="text-center">WildFork E-commerce Dashboard
                        <small></small>
                    </h3>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>
                                <small>WildFork E-commerce Dashboard</small>
                            </h2>

{{--                            @if(can_access_route('new-order-wildfork-ecommerce-export.excel',$userPermissoins))--}}
{{--                                <div class="excel-btn" style="float: right">--}}
{{--                                    <a href="{{ route('new-order-wildfork-ecommerce-export.excel') }}"--}}
