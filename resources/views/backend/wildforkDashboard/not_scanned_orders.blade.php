...
@section('title', 'WildFork E-commerce Not Scanned Orders')
...
@section('inlineJS')
    ...
    <script>
        ...
        $(function () {
            appConfig.set('yajrabox.ajax', '{{ route('new-not-scan-wildfork-ecommerce.data') }}');
...
{{--                            @if(can_access_route('new-not-scan-wildfork-ecommerce-export.excel',$userPermissoins))--}}
{{--                            <div class="excel-btn" style="float: right">--}}
{{--                                <a href="{{ route('new-not-scan-wildfork-ecommerce-export.excel') }}"--}}
