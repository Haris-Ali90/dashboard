...
@section('title', 'Scarborough Reattempted Orders')
...
@section('inlineJS')
    ...
    <script>
        ...
        $(function () {
            ...
            appConfig.set('yajrabox.ajax', '{{ route('to-be-reattemptedorders-scarBorough.data') }}');
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3 class="text-center">{{ $title_name }} To Be Re Attempted Orders<small></small></h3>
                </div>
            </div>
        ...
        @include('backend.scarborough_dashboard.scarborough_cards')
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>{{ $title_name }} <small> To Be Re Attempted Orders</small></h2>
                            ...
                            @endif--}}
                            @if(can_access_route('new-reattemptedorders-scarBorough-tracking-export.excel',$userPermissoins))
                                <div class="excel-btn" style="float: right">
                                    <a href="{{ route('new-reattemptedorders-scarBorough-tracking-export.excel') }}"
                                       class="btn buttons-excel buttons-html5 btn-sm btn-primary excelstyleclass">
