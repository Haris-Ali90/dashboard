...
@section('title', 'Scarborough Route Hub ')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            function getDataOrderFlagHistory(data) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{URL::to('/scarborough/route-details/flag-history-model-html-render')}}",
                    data:parse_data,
...
@section('content')
  ...
  <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script> -->
        ...
        <div class="">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Scarborough <small>Route Detail</small></h2>
                            <div class="clearfix"></div>
                        </div>
    ...
    height: 80px;" alt="'.$routeLoc->tracking_id.'"/>';
                                    ...
                                    echo "<td>"?>
                                    @if(can_access_route('scarborough-route-info.getNotes',$userPermissoins))
                                        @if ($joey != null)
                                        ...
                                        @endif
                                    @endif
                                    @if(can_access_route('scarboroughinfo_route.detail',$userPermissoins))
                                        <a href="{{backend_url('scarborough/route/orders/trackingid/'.$routeLoc->sprint_id.'/details')}}" target='_blank' class='btn btn-warning btn-xs'>Detail</a>
                                    @endif
    ...
    <script>
        function showAddNoteModal(t_id,r_id) {
            ...
            $.ajax({
                type:'GET',
                url:'{{route("scarborough-route-info.getNotes")}}',
        ...
        function sendNote() {
            if($('#myNotesModal #note').val()==''){
                ...
                $.ajax({
                    type:'POST',
                    url:'{{route("scarborough-route-info.addNote")}}',
                    data: formData,
                    // contentType: false,
                    // processData: false,
                    success: function (res) {
