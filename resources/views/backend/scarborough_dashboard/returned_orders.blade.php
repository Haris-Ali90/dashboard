...
@section('inlineJS')
    ...
    <script>
        ...
        $(function () {
            ...
            appConfig.set('yajrabox.ajax', '{{ route('new-returned-scarborough.data') }}');
                            ...
                            <form method="get" action="">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 sm_custm">
                                        @if(can_access_route('new-returned-scarborough-export.excel',$userPermissoins))
                                            <div class="excel-btn" style="float: right">
                                                <a href="{{ route('new-returned-scarborough-export.excel') }}"
