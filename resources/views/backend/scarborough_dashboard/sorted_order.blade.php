...
@section('title', 'Scarborough Sorted Dashboard')
...
@section('inlineJS')
    ...
    <script>
        ...
        $(function () {
            appConfig.set('yajrabox.ajax', '{{ route('new-sort-scarborough.data') }}');
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3 class="">Scarborough Sorted Orders<small></small></h3>
                </div>
            </div>
                            ...
                            <form method="get" action="">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 sm_custm">
                                        @if(can_access_route('new-sort-scarborough-export.excel',$userPermissoins))
                                            <div class="excel-btn" style="float: right">
                                                <a href="{{ route('new-sort-scarborough-export.excel') }}"
