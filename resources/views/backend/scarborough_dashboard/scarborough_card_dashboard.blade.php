...
@section('title', 'Scarborough Statistics')
...
@section('inlineJS')
    ...
    <script>
        ...
        function getTotalOrderData() {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#reattempted_orders').text(data['scarborough_count']['reattempted']);
                    $('#completion_order').text(data['scarborough_count']['completion_ratio']);
                    // hide loader
        ...
        function getInProgressOrdersData() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo URL::to('/'); ?>/scarborough/inprogress/" + selected_date + "/" + type,
                data: {},
                success: function (data) {
                    $('#sorted_remain').text(data['scarborough_inprogess_count']['remaining_sorted']);
                    $('#picked_remain').text(data['scarborough_inprogess_count']['remaining_pickup']);
                    $('#route_picked_remain').text(data['scarborough_inprogess_count']['remaining_route']);
                    // hide loader
        ...
        function getCustomRouteData() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo URL::to('/'); ?>/scarborough/customroutecards/" + selected_date,
                data: {},
                success: function (data) {
        ...
        function getYesterdayOrderData() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo URL::to('/'); ?>/scarborough/yesterdaycards/" + selected_date,
                data: {},
                success: function (data) {
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left amazon-text">
                    <h3 class="text-center">Scarborough Statistics
                        <small></small>
                    </h3>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>
                                <small>Scarborough Statistics</small>
                            </h2>
