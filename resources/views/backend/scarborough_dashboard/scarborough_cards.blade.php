    ...
    @if(in_array($type, ['all','total']))
        <!--Animated-a Div Open-->
            ...
            <div class="animated flipInY col-lg-3 col-md-6 col-sm-12 dashbords-conts-tiles-main-wrap">
                ...
                <a href="<?php echo URL::to('/'); ?>/scarborough/order?datepicker=<?php echo isset($_GET['datepicker'])?$_GET['datepicker']: date('Y-m-d');?>&type=total">
    ...
    @if(in_array($type, ['all','return']))
        <!--Animated-c Div Open-->
            <div class="animated flipInY col-lg-3 col-md-6 col-sm-12 dashbords-conts-tiles-main-wrap">
                ...
                <!--dashbords-conts-tiles-loader-main-wrap-close-->
                    <a href="<?php echo URL::to('/'); ?>/scarborough/returned?datepicker_start=<?php echo isset($_GET['datepicker_start'])?$_GET['datepicker_start']: date('Y-m-d');?>&datepicker_end=<?php echo isset($_GET['datepicker_end'])?$_GET['datepicker_end']: date('Y-m-d');?>&type=return">
                <div class="tile-stats">
                    <div class="icon">
            ...
            <div class="animated flipInY col-lg-3 col-md-6 col-sm-12 dashbords-conts-tiles-main-wrap">
                ...
                <!--dashbords-conts-tiles-loader-main-wrap-close-->
                <a href="<?php echo URL::to('/'); ?>/scarborough/to-be-reattempted-orders?datepicker_start=<?php echo isset($_GET['datepicker_start'])?$_GET['datepicker_start']: date('Y-m-d');?>&datepicker_end=<?php echo isset($_GET['datepicker_end'])?$_GET['datepicker_end']: date('Y-m-d');?>&type=return">
                    <div class="tile-stats">
                        <div class="icon">
                            <i class="fa fa-rotate-left"></i>
                        </div>
                        ...
                        <h3>To Be Re-Attempted Tomorrow</h3>
                    </div>
                </a>
            </div>
            <div class="animated flipInY col-lg-3 col-md-6 col-sm-12 dashbords-conts-tiles-main-wrap">
                ...
                <!--dashbords-conts-tiles-loader-main-wrap-close-->
                <a href="<?php echo URL::to('/'); ?>/scarborough/returned-to-hub-for-re-delivery?datepicker_start=<?php echo isset($_GET['datepicker_start'])?$_GET['datepicker_start']: date('Y-m-d');?>&datepicker_end=<?php echo isset($_GET['datepicker_end'])?$_GET['datepicker_end']: date('Y-m-d');?>&type=return">
                    <div class="tile-stats">
                        <div class="icon">
                            <i class="fa fa-rotate-left"></i>
                        </div>
                        <div class="count" id="re-delivery_orders">0
                        </div>
                        <h3>Returned to hub for re-delivery</h3>
                    </div>
                </a>
            </div>
        @if(in_array($type, ['return']))
            ...
            <div class="animated flipInY col-lg-3 col-md-6 col-sm-12 dashbords-conts-tiles-main-wrap">
                ...
                <!--dashbords-conts-tiles-loader-main-wrap-close-->
                <a href="<?php echo URL::to('/'); ?>/scarborough/received-at-hub?datepicker_start=<?php echo isset($_GET['datepicker_start'])?$_GET['datepicker_start']: date('Y-m-d');?>&datepicker_end=<?php echo isset($_GET['datepicker_end'])?$_GET['datepicker_end']: date('Y-m-d');?>&type=return">
                <div class="tile-stats">
                    <div class="icon">
                        <i class="fa fa-rotate-left"></i>
                    </div>
            ...
            <div class="animated flipInY col-lg-3 col-md-6 col-sm-12 dashbords-conts-tiles-main-wrap">
                ...
                <!--dashbords-conts-tiles-loader-main-wrap-close-->
                <a href="<?php echo URL::to('/'); ?>/scarborough/returned-not-hub?datepicker_start=<?php echo isset($_GET['datepicker_start'])?$_GET['datepicker_start']: date('Y-m-d');?>&datepicker_end=<?php echo isset($_GET['datepicker_end'])?$_GET['datepicker_end']: date('Y-m-d');?>&type=return">
                <div class="tile-stats">
                    <div class="icon">
                        <i class="fa fa-rotate-left"></i>
                    </div>
        ...
        <!--Animated-d Div Open-->
            <div class="animated flipInY col-lg-3 col-md-6 col-sm-12 dashbords-conts-tiles-main-wrap">
                ...
                <!--dashbords-conts-tiles-loader-main-wrap-close-->
                <a href="<?php echo URL::to('/'); ?>/scarborough/sorted?datepicker=<?php echo isset($_GET['datepicker'])?$_GET['datepicker']: date('Y-m-d');?>&type=sorted">
                <div class="tile-stats">
                    <div class="icon">
        ...
        <!--Animated-e Div Open-->
            <div class="animated flipInY col-lg-3 col-md-6 col-sm-12 dashbords-conts-tiles-main-wrap">
                ...
                <!--dashbords-conts-tiles-loader-main-wrap-close-->
                <a href="<?php echo URL::to('/'); ?>/scarborough/picked/up?datepicker=<?php echo isset($_GET['datepicker'])?$_GET['datepicker']: date('Y-m-d');?>&type=picked">
                <div class="tile-stats">
                    <div class="icon">
                        <i class="fa fa-car"></i>
                    </div>
        ...
        <!--Animated-f Div Open-->
            <div class="animated flipInY col-lg-3 col-md-6 col-sm-12 dashbords-conts-tiles-main-wrap">
                ...
                <!--dashbords-conts-tiles-loader-main-wrap-close-->
                <a href="<?php echo URL::to('/'); ?>/scarborough/delivered?datepicker=<?php echo isset($_GET['datepicker'])?$_GET['datepicker']: date('Y-m-d');?>&type=delivered">
                <div class="tile-stats">
                    <div class="icon">
        ...
        <!--Animated-g Div Open-->
            <div class="animated flipInY col-lg-3 col-md-6 col-sm-12 dashbords-conts-tiles-main-wrap">
                ...
                <!--dashbords-conts-tiles-loader-main-wrap-close-->
                <a href="<?php echo URL::to('/'); ?>/scarborough/not/scan?datepicker=<?php echo isset($_GET['datepicker'])?$_GET['datepicker']: date('Y-m-d');?>&type=scan">
                <div class="tile-stats">
                    <div class="icon">
        ...
        <!--Animated-h Div Open-->
            <div class="animated flipInY col-lg-3 col-md-6 col-sm-12 dashbords-conts-tiles-main-wrap">
                ...
                <!--dashbords-conts-tiles-loader-main-wrap-close-->
                <a href="<?php echo URL::to('/'); ?>/scarborough/custom-route?datepicker=<?php echo isset($_GET['datepicker'])?$_GET['datepicker']: date('Y-m-d');?>&type=custom">
                <div class="tile-stats">
                    <div class="icon">
                        <i class="fa fa-cube"></i>
                    </div>
