...
@section('title', 'Scarborough Re Delivery Orders')
...
@section('inlineJS')
    ...
    <script>
        ...
        $(function () {
            ...
            appConfig.set('yajrabox.ajax', '{{ route('re-delivery-orders-scarBorough.data') }}');
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3 class="text-center">{{ $title_name }} Returned To Hub For Re Delivery Orders<small></small></h3>
                </div>
            </div>
        ...
        @include('backend.scarborough_dashboard.scarborough_cards')
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>{{ $title_name }} <small> Returned To Hub For Re Delivery Orders</small></h2>
                            ...
                            @endif--}}
                            @if(can_access_route('re-delivery-orders-scarBorough-tracking-export.excel',$userPermissoins))
                                <div class="excel-btn" style="float: right">
                                    <a href="{{ route('re-delivery-orders-scarBorough-tracking-export.excel') }}"
                                       class="btn buttons-excel buttons-html5 btn-sm btn-primary excelstyleclass">
