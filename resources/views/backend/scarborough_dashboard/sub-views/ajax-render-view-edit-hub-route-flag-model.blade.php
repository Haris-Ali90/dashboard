<ul class="hoverable-dropdown-main-ul">
    @foreach($flagCategories as $category)
        @if($category->isFliterExist('order_type','ecommerce') && $category->isFliterExist('portal','dashboard') && ( $category->isFliterExist('vendor_relation',$request_data['vendor_id']) || !$category->isFliterExist('vendor_relation')) && ($category->isFliterExist('is_show_on_route','0') || $category->isFliterExist('is_show_on_route','2')))
            <li>
