...
@section('title', 'Scarborough Order Details')
                                ...
                                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                    ...
                                    <div id="myTabContent" class="tab-content">
                                        ...
                                        <?php }?>
                                                ...
                                                @if(isset($OldOrderData))
                                        <?php foreach($OldOrderData as $res){

                                        //dd($response->joey_lastname)
                                        ?>
                                            <!---->
                                            <h5 style="clear:both;text-align:left" class="accordion1">
                                                <button class="btn btn-xs orange-gradient color:#000 !important;">Old Status
                                                    History
                                                    <i class="fa fa-angle-down"></i></button>
                                            </h5>
                                            <table id="main" class="table table-striped table-bordered panel"
                                                ...
                                                if(!empty($response['status2'])){
                                                    ...
                                                    $firstattempt = $res['status2'];
                                                    $secondattempt = $res['status'];
                                                    $thirdattempt = $res['status1'];

                                                }
                                                else if(!empty($res['status'])){
                                                    $firstattempt = $res['status'];
                                                    $secondattempt = $res['status1'];
                                                }
                                                else{
                                                    $firstattempt = $res['status1'];
                                                }
