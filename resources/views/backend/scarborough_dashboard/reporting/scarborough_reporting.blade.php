    ...
    <script type="text/javascript">
        ...
        $('.cards-details-datatable-show').on('click', function (e) {
            ...
            function getExportFileName() {
                ...
                return 'Scarborough Summary '+date_date;
            ...
            var table = $('.ctc-total-orders').DataTable({
                ...
                destroy: true,
                ajax: {
                    url: "{{ url('yajra/scarborough/reporting') }}",
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left amazon-text">
                    <h3 class="text-center"> Scarborough Summary
                        <small></small>
                    </h3>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control js-example-basic-multiple vendor_name"
                                                ...
                                                <option value="scarborough_vendors" {{ ($selectVendor=='scarborough_vendors')?'selected': '' }}>Scarborough Hero</option>
                                            </select>
                                        </div>
                                    </div>
                        ...
                        <!--Count Div Row Open-->
                    @include('backend.scarborough_dashboard.reporting.scarborough_reporting_cards')
                    <!--Count Div Row Close-->
