...
@section('title', 'Scarborough Return Received At Hub')
...
@section('inlineJS')
    ...
    <script>
        ...
        $(function () {
            ...
            appConfig.set('yajrabox.ajax', '{{ route('receivedathub-scarBorough.data') }}');
        ...
        @include('backend.scarborough_dashboard.scarborough_cards')
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>{{ $title_name }} <small> Return Received At Hub</small></h2>
                            ...
                            @endif--}}
                            @if(can_access_route('receivedathub-scarBorough-tracking-export.excel',$userPermissoins))
                                <div class="excel-btn" style="float: right">
                                    <a href="{{ route('receivedathub-scarBorough-tracking-export.excel') }}"
                                       class="btn buttons-excel buttons-html5 btn-sm btn-primary excelstyleclass">
