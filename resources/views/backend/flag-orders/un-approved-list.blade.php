                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            @endif
                            @if(can_access_route('multiple.approved.flag',$userPermissoins))
                                <button type="submit"
                                        class="col-md-1 btn btn-success btn-sm multiple-approved-flag approved-for-multiple-flag"
                                        id="showValue"
                                        data-object="{}"
                                        data-id=""
                                        data-tracking_id="" style="display: none"> Marked Approved
                                </button>
                            @endif
...
@section('multi-script')
    <script>
        ...
        function single_checkbox_fn(el,type = 'load') {
            ...
            let btn_data = JSON.parse($('.approved-for-multiple-flag').attr('data-object'));
            if(element.prop("checked") == true)
            {
                btn_data[data_flag_id] = {"tracking_id":tracking_id,"flag_id":data_flag_id};
            }
            else
            {
                ...
                buttons: {
                    'confirm': {
                        ...
                        action: function () {
                            ...
                            $.ajax({
                                type: "GET",
                                url: "{{URL::to('/')}}/multiple/approved/flag",
                                data: {
                                    data: data_object
                                },
                                // success: function (res) {
