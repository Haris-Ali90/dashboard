        ...
        <div class="">
            <div class="page-title">
                <div class="title_left amazon-text">
                    <h3 class="text-center">  Canadian Tire Route Info<small></small></h3>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>CTC <small>Route Info</small></h2>
                            ...
                            <div class="col-sm-12 hoverable-dropdown-main-wrap">
                                ...
                                <ul class="hoverable-dropdown-main-ul">
                                    @foreach($flagCategories as $category)
                                        @if($category->isFliterExist('order_type','ecommerce') && $category->isFliterExist('portal','dashboard') && ( $category->isFliterExist('vendor_relation',$ctcVendorIds) || !$category->isFliterExist('vendor_relation')) && ($category->isFliterExist('is_show_on_route','1') || $category->isFliterExist('is_show_on_route','2')))
                                            <li>
