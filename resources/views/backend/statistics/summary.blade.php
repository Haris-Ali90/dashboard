...
@section('content')
        ...
        <div class="dashboard_pg">
            ...
            <div class="dash_header_wrap">
                <div class="row">
                    ...
                    <div class="col-lg-10 d-flex justify-content-end">
                        <form method="get" action="" id="form1">
                                ...
                                <div class="sort-col d-flex
                                ">
                                    <button type="button" onclick="submitform()" class=" c-btn" style="width: 100%">Search</button>
                                </div>
                ...
                <div class="row">
                        ...
                        <div class="col-lg-10" >
                            <button type="submit" onclick="exportTableToCSV('Summary Report-<?php echo $start_date.' To '.$end_date ?>.csv')" class="btn btn-primary btn-lg c-btn chng_add">Export to Excel</button>
                        </div>
                    </div>
            </div>
            <!-- Header - [/end] -->
    ...
    <script>
        ...
        function submitform() {
            var startDate = '11:00:00';
            var endDate = '09:00:00';
